    ...
    <div class="contents">
        <div class="join-wrap">
            <div class="join-box bg-light">
                ...
                <form class="join-form" id="joinForm" action="${ctx}/member/join" method="POST" >
                    ...
                    <fieldset class="row-none mt-3 mb-0">
                        ...
                        <div class="input-box">
                            ...
                            <a class="btn btn-blue id-check" id="check-duplicate-button" href="#">중복확인</a>
                    ...
                    <div class="mb-3 p-3 border rounded bg-white">
                        <fieldset class="row-between mt-3 mb-1">
                            ...
                            <div class="policy_terms-areement">
                                ...
                                <input name="memberPolicyAgreement" id="policy-agree" class="policy_terms-checkbox"type="checkbox">
                            </div>
                        </fieldset>                            
                        ...
                        <fieldset class="row-between mt-0 mb-1">
                            ...
                            <div class="policy_terms-areement">
                                <p for=""class="policy_terms-detail">상세보기</p>    
                                <input name="memberTermsAgreement" id="terms-agree" class="policy_terms-checkbox"type="checkbox">
                            </div>
                        </fieldset>
                        ...
                        <fieldset class="row-between mt-0">
                            ...
                            <div class="policy_terms-areement">
                                <p for=""class="policy_terms-detail">상세보기</p>    
                                <input name="memberEventAgreement" id="event-agree" class="policy_terms-checkbox"type="checkbox">
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <fieldset class="row-evenly mb-4">
                        ...
                        <a href="#" class="btn btn-red btn-40">가입취소</a>
                    </fieldset>
                </form>
            </div>
        </div>
