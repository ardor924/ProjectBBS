            ...
            <form class="myinfo-form" id="myinfoForm" action="myinfo.do" method="POST" >
                <fieldset class="column-center mt-5 mb-0">
                    <div class="my-photo-frame">
                        ...
                        <input type="file" id="memberPhoto" name="memberPhoto" accept=".jpg, .jpeg, .gif, .png, .bmp, .webp" style="display: none;">
                    </div>
                </fieldset>
                <fieldset class="row-none mt-3 mb-0">
                    ...
                    <div class="input-box">
                        ...
                        name="memberID" id="memberID" value="{admin}" readonly>
                    </div>
                </fieldset>
                ...
                <fieldset class="row-evenly mb-4">
                    ...
                    <a href="#" class="btn btn-red btn-40">수정취소</a>
                </fieldset>
            </form>
        </div>
    </div>
