...
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/admin/category/edit.css"> 
...
<body>
    ...
    <div class="admin-page-wrapper container">    
		...
		<div class="contents">
				...
				<!--관리자패널 : START-->
				<%@ include file="/WEB-INF/views/admin/category/edit_code.jsp" %>
				<!--./관리자패널 : END-->
				
				
				<!--관리자 링크 박스 : START-->
				<%@ include file="/WEB-INF/views/admin/category/edit_admin_links_code.jsp" %>
				<!--./관리자 링크 박스 : END-->
			</div>
        </div>
		<!--./컨텐츠 : END-->
