...
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/admin/category_manage/category_reg.css"> 
...
<body>
    ...
    <div class="wrapper-category-reg container">    
		...
		<!--컨텐츠 : START-->
		<%@ include file="/WEB-INF/views/admin/category_manage/category_reg_code.jsp" %>
		<!--./컨텐츠 : END-->
