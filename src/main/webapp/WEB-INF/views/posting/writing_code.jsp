    ...
    <section class="bbs-area">
        ...
        <fieldset class="bbs-headline  m-0 p-0">
            <div class="row-between  m-0 p-0">
                <h2 class="bbs-title">글쓰기</h2><!--타이틀명만 수정-->  
                <div class="btn-wrap">
                    <a type="button" class="btn-item btn btn-danger" href='${ctx}/bbs/${bbsNameForURL}'><i class="fa-solid fa-x"></i> 취소</a>
					<button type="submit" id="writingSubmitBtn" class="btn-item btn btn-primary">
        ...
        <fieldset class="bbs-main">
            <form class="writing-form" id="editForm" name="editForm"  action="${ctx}/bbs/${bbsNameForURL}/write-page/submit" method="post">
                ...
                <div class="textarea-wrap form-group border">
                    <input class="textara-input form-text" name="postTitle" placeholder="제목을 입력해 주세요."/>
                </div>
                
                 <div>
                    <textarea class="textarea-none" id="editor" name="postContents"></textarea>
                 </div>
            </form>
        </fieldset>
        <!-- ./게시글 메인 : END-->
